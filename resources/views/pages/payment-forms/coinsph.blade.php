                ...
                <div class="col-md-12">
                    <form action="/encashment" method="post">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @csrf
                                <input type="hidden" name="payment_option" value="coinsph">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="COINS PH Wallet Address" name="coinsph_address" required>
                                </div>
                                <div class="form-group">
                                ...
                                <strong>Sending Fee : 0.00 PHP</strong>
                            </div>
